...
/// 三级路由
class BodyRouterDelegate extends RouterDelegate<List<RouteInfo>>
  ...
  /// 获取路由代理对象
  static BodyRouterDelegate of(BuildContext context) {
    final delegate = Router.of(context).routerDelegate;
    assert(delegate is BodyRouterDelegate, 'Delegate type must match');
    return delegate as BodyRouterDelegate;
  }
